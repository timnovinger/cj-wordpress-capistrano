...
<?php
	...
	function general_settings_handler() {
		...
		$this->admin_msg( __( 'General settings saved. Please <a href="' . admin_url('options-general.php?page=admin-customization') . '">refresh</a> to see the changes.', $this->textdomain ) );
	...
	function style_preferences_handler() {
		...
		$this->admin_msg( __( 'Style preferences changes saved. Please <a href="' . admin_url('options-general.php?page=admin-customization') . '">refresh</a> to see the changes.', $this->textdomain ) );
